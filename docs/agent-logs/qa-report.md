...
| Demo products visible | Demo/test/sample/placeholder-tagged products could be displayed by public product queries. | Added shared hidden-tag filtering across homepage, listings, category pages, search API, and product detail related items; search API excludes hidden tags before pagination/counts. |
