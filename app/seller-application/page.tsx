...
const INITIAL: FormData = {
  ...
  storeName: "", category: "", city: "",
  description: "", agree: false,
}

const CATEGORIES = [
  "Elektronik", "Giyim & Aksesuar", "Ev & Yaşam", "Gıda & İçecek",
  "Spor & Outdoor", "Kozmetik & Kişisel Bakım", "Kitap, Müzik & Film",
  "Bebek & Çocuk", "Otomotiv", "Diğer",
]
...
// Cloudflare's always-pass test key — safe for dev/staging.
// Set NEXT_PUBLIC_TURNSTILE_SITE_KEY in production.
...
export default function SellerApplicationPage() {
  ...
  function getToken(): string {
    // Turnstile declarative mode injects a hidden input named "cf-turnstile-response"
        ...
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground leading-relaxed text-pretty">
              Satıcı başvurunuz ekibimize iletildi. En kısa sürede sizinle iletişime geçeceğiz.
            </p>
          </div>
  ...
  return (
    <div className="min-h-screen bg-background">
      {/*
        Turnstile declarative mode: the script auto-discovers any element with
        class="cf-turnstile" and data-sitekey, renders once, and injects a hidden
        input[name="cf-turnstile-response"] — no imperative window.turnstile.render() needed.
      */}
      <Script
        ...
        <div className="grid gap-10 lg:grid-cols-5 lg:gap-14">
          ...
          <aside className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1 text-pretty">KKTC&apos;de e-ticarete adım atmak için en doğru platform.</p>
            </div>
            ...
            <div className="rounded-xl border bg-secondary/40 p-4 space-y-1">
              ...
              <a href="mailto:info@marketin24.com" className="flex items-center gap-2 text-sm font-medium text-primary hover:underline">
          ...
          <div className="lg:col-span-3">
            <div className="rounded-2xl border bg-card p-6 md:p-8 shadow-sm">
              ...
              <form id={formId} ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-5">
                ...
                {/*
                  Declarative Turnstile: class="cf-turnstile" + data-sitekey is all that's needed.
                  The script auto-renders the widget and injects a hidden input[name="cf-turnstile-response"].
                  data-callback is not needed — we read the hidden input on submit via formRef.
                */}
                <div>
                  <div
