...
// Cloudflare Turnstile widget — loaded via Script tag, rendered into a div
declare global {
  interface Window {
    turnstile?: {
...
export default function SellerApplicationPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      ...
      // Always show success regardless of server outcome — prevents enumeration
      setSubmitted(true)
    })
  }
  ...
  if (submitted) {
    return (
      <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
        <div className="max-w-md w-full text-center space-y-6 animate-slide-in-up">
                ...
                <div className="space-y-1">
                  <label className="flex items-start gap-2.5 cursor-pointer group">
                    ...
                    <span className="text-sm text-muted-foreground leading-relaxed group-hover:text-foreground transition-colors">
                      <Link href="#" className="text-primary underline underline-offset-2 hover:text-primary/80">Kullanım Koşulları</Link>
                      {" "}ve{" "}
                      <Link href="#" className="text-primary underline underline-offset-2 hover:text-primary/80">Gizlilik Politikası</Link>
...
export default function SellerApplicationPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      ...
      setSubmitted(true)
      // Also open email client as secondary confirmation
      const subject = encodeURIComponent("Satıcı Başvurusu – " + form.storeName)
      const body = encodeURIComponent(
        `Ad Soyad: ${form.fullName}\nE-posta: ${form.email}\nTelefon: ${form.phone}\nMağaza Adı: ${form.storeName}\nKategori: ${form.category}\nŞehir: ${form.city}\n\nAçıklama:\n${form.description}`
      )
      ...
      <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
        <div className="max-w-md w-full text-center space-y-6 animate-slide-in-up">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold text-balance">Başvurunuz Alındı!</h1>
            <p className="text-muted-foreground leading-relaxed text-pretty">
              Satıcı başvurunuz başarıyla alındı ve inceleme aşamasına girdi. Ekibimiz en kısa sürede sizinle iletişime geçecektir.
            </p>
          </div>
          <div className="rounded-xl border bg-secondary/50 p-4 space-y-3 text-left">
            <div className="flex items-start gap-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Sonuç <span className="font-medium">{form.email}</span> adresine iletilecektir.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            <div className="rounded-2xl border bg-card p-6 md:p-8 shadow-sm">
              ...
              <form id={formId} onSubmit={handleSubmit} noValidate className="space-y-5">
                ...
                <p className="text-center text-xs text-muted-foreground">
                  Başvurunuz aynı zamanda{" "}
                  <span className="font-medium text-foreground">info@marketin24.com</span>
                  {" "}adresine e-posta olarak da iletilecektir.
                </p>
              </form>
            </div>
          </div>
