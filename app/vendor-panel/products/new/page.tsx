...
import {
  ArrowLeft, Loader2, Save, Upload, X, Plus, ImagePlus, Tag,
} from "lucide-react"
...
import { SmartVariantEditor, variantsToTags, type VariantSet } from "@/components/vendor/smart-variant-editor"
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    startTx(async () => {
      try {
        ...
        const json = await parseJsonResponse<{ error?: string }>(res, "Ürün kaydedilemedi")
