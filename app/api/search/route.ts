...
const searchQuerySchema = z
  .object({
    ...
    min_price: z.coerce.number().finite().min(1).nullable().default(null),
    max_price: z.coerce.number().finite().min(1).nullable().default(null),
    tags: z.string().trim().default(""),
    page: z.coerce.number().int().min(1).default(1),
  })
  .refine(
    ({ min_price, max_price }) => min_price === null || max_price === null || min_price <= max_price,
